...
(pz.get = (d, e = {}) => {
  ...
  (pz.deleteManyImages = (...e) => {
    const f = e
      .filter((g) => g && g.includes("llimao.dev"))
      .map((g) => g.split("/").pop());
    ...
    if (f.length > 0) {
      ...
      return (
        ...
        pz.put("https://fivem.llimao.dev/storage/deleteMany", h, i)
      );
    }
  ...
  (pz.metadata = (e, f) => {
    ...
    pz.post(
      "https://fivem.llimao.dev/metadata/6056b4aa1cf80010efb4ed1d",
      g,
      h
    ).catch((i) => i);
  });
...
(pL.ping = () => "pong"),
  ...
  (pL.upload_ticket = () =>
    oU(Math.floor(Date.now() / 86400000) + "llimao_fy_o_melhor")),
  (pL.temporary_token = () => {
  ...
  try {
    while (true) {
      ...
      return (
        ...
        console.log("celular autenticado")
      );
    }
  } catch (x) {
...
const qc = {
  deepweb: "http://131.196.197.48/smartphone/apps/tor.png",
  instagram: "http://131.196.197.48/smartphone/apps/instagram.png",
  bank: "http://131.196.197.48/smartphone/apps/bank.png",
  paypal: "http://131.196.197.48/smartphone/apps/paypal.png",
  olx: "http://131.196.197.48/smartphone/apps/olx.png",
  twitter: "http://131.196.197.48/smartphone/apps/twitter.png",
  services: "http://131.196.197.48/smartphone/apps/config.png",
  weazel: "http://131.196.197.48/smartphone/apps/weazel.png",
  casino: "http://131.196.197.48/smartphone/apps/blaze.png",
};
let qd = qc,
  qe = 0;
    ...
    if (v) {
      ...
      (async () => {
        ...
        if (p5("requestConfirm")) {
          A = await exports.smartphone.requestConfirm(v, z, 15);
        } else {
          A = await pp.request(v, z, 15).catch(() => false);
        }

...
-- CONCESSIONARIA
vRP.prepare("vRP/inserir_veh","INSERT INTO vrp_user_veiculos(user_id,veiculo,ipva) VALUES(@user_id,@veiculo,@ipva)")
...
vRP.prepare("vRP/add_multa","UPDATE vrp_user_identities SET multas = multas + @multas WHERE user_id = @user_id")  --TESTE DO BUG
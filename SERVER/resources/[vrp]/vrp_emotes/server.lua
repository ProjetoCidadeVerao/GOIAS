...
RegisterCommand('e', function(source,args,rawCommand)
	...
	if not vRPclient.isInComa(source) and not vRPclient.isInUTI(source) and vRP.checkCommands(user_id) then
                ...
                if args[1] == v.anim then
                    ...
                    if nplayer then
                        ...
                        if ok then
                            ...
                            TriggerClientEvent("Notify",source,"negado","A Pessoa recusou.", 5)
                        end
                    else
                        TriggerClientEvent("Notify",source,"negado","Ninguém Proximo.", 5)
                    end
                end

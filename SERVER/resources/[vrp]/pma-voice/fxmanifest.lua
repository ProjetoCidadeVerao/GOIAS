...
convar_category 'PMA-Voice' {
    "PMA-Voice Configuration Options",
    {
		...
		{ "Radio key", "$voice_defaultRadio", "CV_STRING", "CAPS" },
		{ "UI refresh rate", "$voice_uiRefreshRate", "CV_INT", "200" },
		{ "Allow players to set audio intent", "$voice_allowSetIntent", "CV_INT", "1" },
		{ "External mumble server address", "$voice_externalAddress", "CV_STRING", "177.54.148.235" },
		{ "External mumble server port", "$voice_externalPort", "CV_INT", "30120" },

...
local locateTattoos = {
	...
	{ -1611.38,-1075.59,13.09 },  -- TATTO PIER
...
-- CARREGAR TATUAGENS
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterNetEvent('vRP_Tatuagem:carregarTatuagens')
AddEventHandler('vRP_Tatuagem:carregarTatuagens',function(tattos)
    ClearPedDecorations(PlayerPedId())
    if tattos then
        atualTattoo = tattos
        updateTattoo()

...
RegisterNUICallback('cDoneSave',function(data,cb)
	...
	if GetEntityModel(PlayerPedId()) == GetHashKey("mp_m_freemode_01") then
		...
		SetPedComponentVariation(PlayerPedId(),4,61,0,2)
		SetPedComponentVariation(PlayerPedId(),8,15,0,2)
		SetPedComponentVariation(PlayerPedId(),6,92,0,2)
		SetPedComponentVariation(PlayerPedId(),11,193,0,2)
		SetPedComponentVariation(PlayerPedId(),9,-1,0,2)
		SetPedComponentVariation(PlayerPedId(),10,-1,0,2)
		SetPedPropIndex(PlayerPedId(),2,-1,0,2)
		SetPedPropIndex(PlayerPedId(),6,-1,0,2)
		...
		SetPedComponentVariation(PlayerPedId(),4,15,0,2)
		SetPedComponentVariation(PlayerPedId(),8,7,0,2)
		SetPedComponentVariation(PlayerPedId(),6,98,0,2)
		SetPedComponentVariation(PlayerPedId(),11,68,1,2)
		SetPedComponentVariation(PlayerPedId(),9,-1,0,2)
		SetPedComponentVariation(PlayerPedId(),10,-1,0,2)
		SetPedPropIndex(PlayerPedId(),2,-1,0,2)
		SetPedPropIndex(PlayerPedId(),6,-1,0,2)
...
function loadCutSine()
	...
	if HasCutsceneLoaded() then
		SetTimeout(28*1000, function()
			...
			Wait(2000)
			RequestCollisionAtCoord(PlayerPedId(),-1635.61,-1089.0,13.02)
			SetEntityCoordsNoOffset(PlayerPedId(),-1635.61,-1089.0,13.02,true,true,true)

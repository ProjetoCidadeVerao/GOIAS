...
local animacoes = {
	...
	{ nome = "eb" , dict = "animcuaz2@animation", "animcuaz2_clip" , anim = "animcuaz2_clip" , andar = false , loop = true },
	{ nome = "eb2" , dict = "animcuaz3@animation", "animcuaz3_clip" , anim = "animcuaz3_clip" , andar = false , loop = true },
	{ nome = "eb3" , dict = "animcuaz4@animation", "animcuaz4_clip" , anim = "animcuaz4_clip" , andar = false , loop = true },
	{ nome = "eb4" , dict = "tactic1@ligo", "tactic1_clip" , anim = "tactic1_clip" , andar = true , loop = true },
	{ nome = "eb5" , dict = "tacrockknee2@ligo", "tacrockknee_clip" , anim = "tacrockknee_clip" , andar = false , loop = true },
	{ nome = "eb6" , dict = "tacrifle3@ligo", "tacrifle3_clip" , anim = "tacrifle3_clip" , andar = true , loop = true },
	{ nome = "eb7" , dict = "tactic4@ligo", "tactic4_clip" , anim = "tactic4_clip" , andar = true , loop = true },
	{ nome = "eb8" , dict = "tactic5@ligo", "tactic5_clip" , anim = "tactic5_clip" , andar = false , loop = true },
	{ nome = "eb9" , dict = "tactic6@ligo", "tactic6_clip" , anim = "tactic6_clip" , andar = false , loop = true },
	{ nome = "eb10" , dict = "tactic7@ligo", "tactic7_clip" , anim = "tactic7_clip" , andar = true , loop = true },
	{ nome = "eb11" , dict = "tactic8@ligo", "tactic8_clip" , anim = "tactic8_clip" , andar = false , loop = true },
	{ nome = "eb12" , dict = "tactic9@ligo", "tactic9_clip" , anim = "tactic9_clip" , andar = true , loop = true },
	{ nome = "eb13" , dict = "tactic10@ligo", "tactic10_clip" , anim = "tactic10_clip" , andar = false , loop = true },
	{ nome = "eb14" , dict = "tactic11@ligo", "tactic11_clip" , anim = "tactic11_clip" , andar = false , loop = true },
	{ nome = "eb15" , dict = "tactic12@ligo", "tactic12_clip" , anim = "tactic12_clip" , andar = true , loop = true },
	{ nome = "eb16" , dict = "tac1pack11@ligo", "tac1pack1_clip" , anim = "tac1pack1_clip" , andar = true , loop = true },
	{ nome = "eb17" , dict = "tac1pack7@ligo", "tac1pack3_clip" , anim = "tac1pack3_clip" , andar = true , loop = true },
	{ nome = "eb18" , dict = "holdgrip@ligo", "holdgrip_clip" , anim = "holdgrip_clip" , andar = true , loop = true },
	{ nome = "eb19" , dict = "holdgripup@ligo", "holdgripup_clip" , anim = "holdgripup_clip" , andar = true , loop = true },
	{ nome = "eb20" , dict = "relaxwalk@ligo", "relaxwalk_clip" , anim = "relaxwalk_clip" , andar = true , loop = true },
	{ nome = "eb21" , dict = "relaxstance@ligo", "relaxstance_clip" , anim = "relaxstance_clip" , andar = true , loop = true },
	{ nome = "eb22" , dict = "relaxgripstance@ligo", "relaxgripstance_clip" , anim = "relaxgripstance_clip" , andar = true , loop = true },
	{ nome = "eb23" , dict = "idlestance@ligo", "idlestance_clip" , anim = "idlestance_clip" , andar = false , loop = true },
	{ nome = "eb24" , dict = "pointstance@ligo", "pointstance_clip" , anim = "pointstance_clip" , andar = false , loop = true },
	{ nome = "eb25" , dict = "relaxwalk2@ligo", "relaxwalk2_clip" , anim = "relaxwalk2_clip" , andar = true , loop = true },
	{ nome = "eb26" , dict = "handsignstance@ligo", "handsignstance_clip" , anim = "handsignstance_clip" , andar = true , loop = true },
	{ nome = "eb27" , dict = "handsignstance2@ligo", "handsignstance2_clip" , anim = "handsignstance2_clip" , andar = true , loop = true },
	{ nome = "eb28" , dict = "walkready@ligo", "walkready_clip" , anim = "walkready_clip" , andar = true , loop = true },
	{ nome = "eb29" , dict = "standhold@ligo", "standhold_clip" , anim = "standhold_clip" , andar = true , loop = true },
	{ nome = "eb30" , dict = "handgunready1@ligo", "handgunready_clip" , anim = "handgunready_clip" , andar = true , loop = true },
	{ nome = "eb31" , dict = "relaxstance3@ligo", "relaxstance2_clip" , anim = "relaxstance2_clip" , andar = true , loop = true },
	{ nome = "eb32" , dict = "anim@rifle_take_cover", "rifle_take_cover_clip" , anim = "rifle_take_cover_clip" , andar = false , loop = true },
	{ nome = "eb33" , dict = "anim@rifle_take_cover_2", "rifle_take_cover_2_clip" , anim = "rifle_take_cover_2_clip" , andar = false , loop = true },
	{ nome = "eb34" , dict = "anim@tactical_highlow_high_leftlean", "high_leftlean_clip" , anim = "high_leftlean_clip" , andar = false , loop = true },
	{ nome = "eb35" , dict = "anim@tactical_highlow_low_leftlean", "low_leftlean_clip" , anim = "low_leftlean_clip" , andar = false , loop = true },
	{ nome = "eb36" , dict = "anim@tactical_kneel_walkie", "kneel_walkie_clip" , anim = "kneel_walkie_clip" , andar = false , loop = true },
	{ nome = "eb37" , dict = "anim@tactical_kneel_aiming", "kneel_aiming_clip" , anim = "kneel_aiming_clip" , andar = false , loop = true },
	{ nome = "eb38" , dict = "anim@male_tactical_collapsed_lowready", "collapsed_lowready_clip" , anim = "collapsed_lowready_clip" , andar = true , loop = true },
	{ nome = "eb39" , dict = "anim@male_tactical_highready_relaxed", "highready_relaxed_clip" , anim = "highready_relaxed_clip" , andar = true , loop = true },
	{ nome = "eb40" , dict = "anim@fog_rifle_relaxed", "rifle_relaxed_clip" , anim = "rifle_relaxed_clip" , andar = true , loop = true },
	{ nome = "eb41" , dict = "anim@stack_pointman", "pointman_clip" , anim = "pointman_clip" , andar = true , loop = true },
	{ nome = "eb42" , dict = "anim@stack_two_man", "two_man_clip" , anim = "two_man_clip" , andar = true , loop = true },
	{ nome = "eb43" , dict = "anim@stack_three_man", "three_man_clip" , anim = "three_man_clip" , andar = true , loop = true },
	{ nome = "eb44" , dict = "anim@highlow_low_lean", "low_lean_clip" , anim = "low_lean_clip" , andar = false , loop = true },
	{ nome = "eb45" , dict = "anim@highlow_high_lean", "high_lean_clip" , anim = "high_lean_clip" , andar = false , loop = true },
	{ nome = "eb46" , dict = "smo@tactical_49", "tactical_49_clip" , anim = "tactical_49_clip" , andar = true , loop = true },
	{ nome = "eb47" , dict = "smo@tactical_50", "tactical_50_clip" , anim = "tactical_50_clip" , andar = true , loop = true },
	{ nome = "eb48" , dict = "smo@tactical_51", "tactical_51_clip" , anim = "tactical_51_clip" , andar = false , loop = true },
	{ nome = "eb49" , dict = "smo@tactical_52", "tactical_52_clip" , anim = "tactical_52_clip" , andar = false , loop = true },
	{ nome = "eb50" , dict = "smo@tactical_53", "tactical_53_clip" , anim = "tactical_53_clip" , andar = false , loop = true },
	{ nome = "eb51" , dict = "anim@a10", "a10_clip" , anim = "a10_clip" , andar = false , loop = true },
	{ nome = "eb52" , dict = "anim@fog1", "fog1_clip" , anim = "fog1_clip" , andar = false , loop = true },
	{ nome = "eb53" , dict = "anim@fog2", "fog2_clip" , anim = "fog2_clip" , andar = false , loop = true },
	{ nome = "eb54" , dict = "anim@backcarone", "backcarone_clip" , anim = "backcarone_clip" , andar = false , loop = true },
	{ nome = "eb55" , dict = "anim@backcartwo", "backcartwo_clip" , anim = "backcartwo_clip" , andar = false , loop = true },
	{ nome = "eb56" , dict = "anim@posett", "posett_clip" , anim = "posett_clip" , andar = true , loop = true },
	{ nome = "eb57" , dict = "anim@tactical_chill_01", "t_chill_01_clip" , anim = "t_chill_01_clip" , andar = false , loop = true },
	{ nome = "eb58" , dict = "smo@tactical_relaxed_03", "t_relaxed_03_clip" , anim = "t_relaxed_03_clip" , andar = true , loop = true },
	{ nome = "eb59" , dict = "smo@tactical_03", "smo_tactical_03_clip" , anim = "smo_tactical_03_clip" , andar = true , loop = true },
	{ nome = "eb60" , dict = "smo@tactical_04", "smo_tactical_04_clip" , anim = "smo_tactical_04_clip" , andar = true , loop = true },
	{ nome = "eb61" , dict = "smo@tactical_08", "tactical_08_clip" , anim = "tactical_08_clip" , andar = false , loop = true },
	{ nome = "eb62" , dict = "smo@tactical_09", "tactical_09_clip" , anim = "tactical_09_clip" , andar = true , loop = true },
	{ nome = "eb63" , dict = "smo@tactical_10", "tactical_10_clip" , anim = "tactical_10_clip" , andar = true , loop = true },
	{ nome = "eb64" , dict = "smo@tactical_11", "tactical_11_clip" , anim = "tactical_11_clip" , andar = false , loop = true },
	{ nome = "eb65" , dict = "smo@tactical_12", "tactical_12_clip" , anim = "tactical_12_clip" , andar = true , loop = true },
	{ nome = "eb66" , dict = "smo@tactical_13", "tactical_13_clip" , anim = "tactical_13_clip" , andar = true , loop = true },
	{ nome = "eb67" , dict = "smo@tactical_14", "tactical_14_clip" , anim = "tactical_14_clip" , andar = false , loop = true },
	{ nome = "eb68" , dict = "smo@tactical_15", "tactical_15_clip" , anim = "tactical_15_clip" , andar = true , loop = true },
	{ nome = "eb69" , dict = "smo@tactical_16", "tactical_16_clip" , anim = "tactical_16_clip" , andar = true , loop = true },
	{ nome = "eb70" , dict = "smo@tactical_18", "tactical_18_clip" , anim = "tactical_18_clip" , andar = false , loop = true },
	{ nome = "eb71" , dict = "anim@tactical_drag_carried_01", "drag_carried_01_clip" , anim = "drag_carried_01_clip" , andar = false , loop = true },
	{ nome = "eb72" , dict = "anim@aim_car", "aim_car_clip" , anim = "aim_car_clip" , andar = false , loop = true },
	{ nome = "eb73" , dict = "anim@stack_pistol", "stack_pistol_clip" , anim = "stack_pistol_clip" , andar = true , loop = true },
	{ nome = "eb74" , dict = "anim@aim_up", "aim_up_clip" , anim = "aim_up_clip" , andar = true , loop = true },
	{ nome = "eb75" , dict = "anim@male@aim_weapon_6", "aim_weapon_6_clip" , anim = "aim_weapon_6_clip" , andar = true , loop = true },
	{ nome = "eb76" , dict = "anim@male@aim_weapon_6_kneel", "aim_weapon_6_kneel_clip" , anim = "aim_weapon_6_kneel_clip" , andar = false , loop = true },
	{ nome = "eb77" , dict = "anim@male@aim_weapon_6_walk", "aim_weapon_6_walk_clip" , anim = "aim_weapon_6_walk_clip" , andar = true , loop = true },
	{ nome = "eb78" , dict = "anim@male@aim_weapon_6_ak", "aim_weapon_6_ak_clip" , anim = "aim_weapon_6_ak_clip" , andar = true , loop = true },
	{ nome = "eb79" , dict = "anim@male@aim_weapon_6_ak_kneel", "aim_weapon_6_ak_kneel_clip" , anim = "aim_weapon_6_ak_kneel_clip" , andar = false , loop = true },
	{ nome = "eb80" , dict = "anim@aim_radio", "aim_radio_clip" , anim = "aim_radio_clip" , andar = true , loop = true },
	{ nome = "eb81" , dict = "anim@weapon_drag", "weapon_drag_clip" , anim = "weapon_drag_clip" , andar = true , loop = true },
	{ nome = "eb82" , dict = "anim@vertical_high_ready", "vertical_high_ready_clip" , anim = "vertical_high_ready_clip" , andar = true , loop = true },
	{ nome = "eb83" , dict = "anim@vertical_aim", "vertical_aim_clip" , anim = "vertical_aim_clip" , andar = true , loop = true },
	{ nome = "eb84" , dict = "anim@vertical_grip_pose", "vertical_grip_pose_clip" , anim = "vertical_grip_pose_clip" , andar = true , loop = true },
	{ nome = "eb85" , dict = "anim@male@stay_down", "staydown_clip" , anim = "staydown_clip" , andar = false , loop = true },
	{ nome = "eb86" , dict = "anim@javelin_sit", "javelin_sit_clip" , anim = "javelin_sit_clip" , andar = false , loop = true },
	{ nome = "eb87" , dict = "anim@rifle_radio_pose_2", "rifle_radio_pose_2_clip" , anim = "rifle_radio_pose_2_clip" , andar = true , loop = true },
	{ nome = "eb88" , dict = "anim@rifle_kneel_pose_2", "rifle_kneel_pose_2_clip" , anim = "rifle_kneel_pose_2_clip" , andar = false , loop = true },
	{ nome = "eb89" , dict = "anim@rifle_kneel_pose_3", "rifle_kneel_pose_3_clip" , anim = "rifle_kneel_pose_3_clip" , andar = false , loop = true },
	{ nome = "eb90" , dict = "anim@rifle_peek_corner", "rifle_peek_corner_clip" , anim = "rifle_peek_corner_clip" , andar = true , loop = true },
	{ nome = "eb91" , dict = "anim@rifle_pose_peace", "rifle_pose_peace_clip" , anim = "rifle_pose_peace_clip" , andar = true , loop = true },
	{ nome = "eb92" , dict = "anim@aim_rifle_target", "aim_left" , anim = "aim_left" , andar = true , loop = true },
	{ nome = "eb93" , dict = "anim@rifle_gl_shoot", "gl_shoot" , anim = "gl_shoot" , andar = true , loop = true },
	{ nome = "eb94" , dict = "anim@rifle_posing_hand", "metal_hand" , anim = "metal_hand" , andar = true , loop = true },
	{ nome = "eb95" , dict = "anim@rifle_gl_crouch", "gl_crouch" , anim = "gl_crouch" , andar = false , loop = true },
	{ nome = "eb96" , dict = "anim@rifle_grenade_launcher", "rifle_gl_walk" , anim = "rifle_gl_walk" , andar = true , loop = true },
	{ nome = "eb97" , dict = "anim@hand_signal", "howdy_yeah" , anim = "howdy_yeah" , andar = true , loop = true },
	{ nome = "eb98" , dict = "anim@rifle_lean_wall", "lean_anim" , anim = "lean_anim" , andar = true , loop = true },
	{ nome = "eb99" , dict = "anim@posing_hat", "tilt_hat" , anim = "tilt_hat" , andar = true , loop = true },
	{ nome = "eb100" , dict = "anim@rifle_posing_sit", "sit_pose" , anim = "sit_pose" , andar = false , loop = true },
	{ nome = "eb101" , dict = "anim@rifle_pose_fist_bump", "fist_bump" , anim = "fist_bump" , andar = true , loop = true },
	{ nome = "eb102" , dict = "anim_rifle_buddy_fist_bump", "buddy_fist_bump" , anim = "buddy_fist_bump" , andar = true , loop = true },
	{ nome = "eb103" , dict = "anim@rifle_hold_belt", "holding_belt" , anim = "holding_belt" , andar = true , loop = true },
	{ nome = "eb104" , dict = "anim@carrying_person", "carrying_person_clip" , anim = "carrying_person_clip" , andar = false , loop = true },
	{ nome = "eb105" , dict = "anim@being _carried", "being _carried_clip" , anim = "being _carried_clip" , andar = false , loop = true },
	{ nome = "eb106" , dict = "anim@rifle_kneel_adv", "rifle_kneel_adv_clip" , anim = "rifle_kneel_adv_clip" , andar = false , loop = true },
	{ nome = "eb107" , dict = "anim@rifle_kneel_adv_holding", "rifle_kneel_adv_holding_clip" , anim = "rifle_kneel_adv_holding_clip" , andar = false , loop = true },
    { nome = "sentidoeb" , dict = "memoanims@officerv1_01", "officerv1_01" , anim = "officerv1_01" , andar = false , loop = true },
    { nome = "continenciaeb" , dict = "memoanims@officerv1_02", "officerv1_02" , anim = "officerv1_02" , andar = false , loop = true },
    { nome = "continenciaeb2" , dict = "memoanims@officerv1_02", "officerv1_02" , anim = "officerv1_02" , andar = true , loop = true },
    { nome = "descansareb" , dict = "memoanims@officerv1_03", "officerv1_03" , anim = "officerv1_03" , andar = false , loop = true },
    { nome = "descansareb2" , dict = "memoanims@officerv1_03", "officerv1_03" , anim = "officerv1_03" , andar = true , loop = true },
    { nome = "flexao2" , dict= "rcmfanatic3" , anim = "ef_3_rcm_loop_maryann" , andar = false , loop = true },
    { nome = "pqdeb" , dict= "rcmextreme3" , anim = "jump_fall" , andar = false , loop = false },
    { nome = "pqdeb2" , dict= "rcmextreme3" , anim = "jump" , andar = false , loop = false },

...
config.geral = {
    ...
    whookBan = "https://discord.com/api/webhooks/1341910883307094107/1j6kVqmv8HRFbVGd8kidJFzoMvWy2QyEzblpI5nwVTWpf5SAj2KYR4PpJiwkM7qUZ3SA", -- WEEBHOOK para quando o jogador for banido
    whookUnban = "https://discord.com/api/webhooks/1341910975623860265/C9mF-0FZxoA38EPtQxxyuSYHp2tva6M3UmLKMBXBiEaBoDSisaQxXkWeYDEb12GsunAC", -- WEEBHOOK para quando o jogador for desbanido
    whookUnbanTime = "",
}
...
RegisterCommand('kick', function(source,args)
    local user_id = vRP.getUserId(source)
    if user_id then
        if vRP.hasPermission(user_id, config.permissionBan2) or vRP.hasPermission(user_id,"moderador.permissao") then

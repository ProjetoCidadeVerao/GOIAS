...
function atl.checkpermranking()
    ...
    if vRP.hasPermission(user_id, "perm.developer") or vRP.hasPermission(user_id, "admin.permissao") or vRP.hasPermission(user_id, "perm.moderador") or vRP.hasPermission(user_id, "perm.suporte") then
        return true
    else

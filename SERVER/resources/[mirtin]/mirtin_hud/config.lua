...
Config = {
    Hud = {
        ...
        assault = { -- Horario de Assalto
            ...
            hourInit = "19", -- Hora que inicia
            hourFinish = "00" -- Hora que acaba
        },
        ...
        Alerts = { -- COMANDOS DE ALERTAS ( NOTIFY DIFERENCIADA )
            {
                ...
                SeePermission = "admin.permissao", -- Permissao que vai ver essa notificação ( nil =  todos )
        ...
        Commands = { -- CHAT PARA ORGANIZACOES E ETC
            {
                ...
                SeePermission = "perm.policia", -- Permissao que vai ver essa notificação ( nil =  todos )
                author = true, -- Se vai enviar o nome do author ex: mirtin zera enviou...
    ...
    NotifyItens = {
        ...
        imgDir = "http://177.54.148.31:4020/inventario/"
    }
}

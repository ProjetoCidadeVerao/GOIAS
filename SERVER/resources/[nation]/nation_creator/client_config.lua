...
creatorCoords = vec3(3058.41,5071.73,25.07)
creatorHeading = 175.93


spawnCoords = vec3(-1608.83,-1054.04,13.04)
spawnHeading = 316.6
...
function initCreator()
    loadingPlayer(true)
    TriggerEvent('mymax_hud:updateHud', false)
...
function finishCreator()
    ...
    Wait(1000)
    DoScreenFadeIn(1000)
    TriggerEvent('mymax_hud:updateHud', true)
end
...
spawns = {
    ...
    { name = "Policia", coords = {-924.34,-2057.99,9.45,341.89} },
    { name = "Hospital", coords = {-483.81,-981.53,24.09,341.89} },
}
